    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        carb.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                value = (((int) val < 9999) ? String.valueOf((int) val) : "9999+");
                co2_field.setText(value);

                // AQI %
                double progress = val / 1500;
                ...
                // Comment_Val
                String message = (progressPercentage < 47) ? "THE AIR QUALITY IS GOOD" :
                        (progressPercentage < 67) ? "THE AIR QUALITY IS MODERATE" : "THE AIR QUALITY IS BAD";
                comment.setText(message);

                // Measures taken
                LayerDrawable layerDrawable = (LayerDrawable) pb.getProgressDrawable();
                if (progressPercentage < 47) {
